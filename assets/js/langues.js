...
(function () {
    ...
    const CONTENU_TRADUIT = { en: ["apprendre", "cybersecurite", "data", "design", "dev-web", "droit", "ecologie", "entrepreneuriat", "finance", "ia", "marketing", "negociation", "productivite", "sante"], es: [], de: [], it: [], zh: [], ru: [], hu: ["apprendre", "cybersecurite", "data", "design", "dev-web", "droit", "ecologie", "entrepreneuriat", "finance", "ia", "marketing", "negociation", "productivite", "sante"] };
    ...
    const PAGES_TRADUITES = {
        ...
        hu: ["index.html", "guides.html", "actualites.html", "podcasts.html", "glossaire.html",
             "faq.html", "a-propos.html", "mentions-legales.html", "idees.html", "mon-espace.html"],
    };
