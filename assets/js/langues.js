...
(function () {
    ...
    const CONTENU_TRADUIT = { en: ["apprendre", "cybersecurite", "data", "design", "dev-web", "droit", "ecologie", "entrepreneuriat", "finance", "ia", "marketing", "negociation", "productivite", "sante"], es: [], de: [], it: [], zh: [], ru: [], hu: ["apprendre", "cybersecurite", "data", "design", "dev-web", "ecologie", "entrepreneuriat", "finance", "ia", "marketing", "negociation", "productivite"] };
