// ===================================
// QUESTION BANK — DIGITAL MARKETING, BEGINNER LEVEL (EN)
// ===================================
...
window.QUIZ = {
    sections: {
        ...
        "seo": [
            // Series 1
            {
                q: "What are the three pillars of search ranking?",
                options: [
                    "Budget, advertising and social networks",
                    "Content, technical, and popularity",
                    "The domain name, the logo and the visual identity"
                ],
                a: 1,
                explication: "Content accounts for about 70% of the work: genuinely answering the question asked."
            },
            {
            ...
            // Series 2
            {
                q: "What does artificially repeating a keyword produce today?",
                options: [
                    "A better ranking",
        ...
        "online-advertising": [
            // Series 1
            {
                ...
                a: 1,
                explication: "A well-designed ad costs less than a mediocre one, at equal position."
            },
            {
                q: "€1,000 budget, €1.20 per click, 2% conversion. What is the cost per customer?",
                options: ["€12", "about €59", "about €120"],
                a: 1,
                explication: "833 visitors, 17 customers, that is 1,000 / 17 ≈ €59. Profitable only if a customer brings in more."
            },
            {
            ...
            // Series 2
            {
                q: "What is the difference between advertising on a search engine and on social networks?",
                options: [
                    "None, only the medium changes",
                    "On a search engine the person is already expressing a need; on a network you interrupt them",
                    "Social networks always convert better"
                ],
                a: 1,
                explication: "Hence better conversion on search, but a higher cost per click."
            },
            {
                ...
                a: 1,
                explication: "It is the cheapest and most profitable correction in online advertising."
            },
            {
        ...
        "social-networks": [
            // Series 1
            {
                q: "Which platform should you favour for selling to businesses?",
                options: ["TikTok", "LinkedIn", "Instagram"],
                a: 1,
                explication: "Instagram suits visual products, TikTok the general public, YouTube complex subjects."
            },
            {
            ...
            // Series 2
            {
                q: "What strategic consequence follows from that fall in reach?",
                options: [
                    "Posting far more often",
                    "Converting your audience into a channel you own, such as an email list",
                    "Paying for every single post"
                ],
                a: 1,
                explication: "An account can be suspended, a reach can collapse; a subscriber list stays."
            },
            {
        ...
        "email-marketing": [
            // Series 1
            {
                q: "Why does email remain the channel with the best return?",
                options: [
                    "Because it is free",
                    "Because the list belongs to you, with no algorithm between you and your subscribers",
                    "Because people read all their messages"
                ],
                a: 1,
                explication: "It is the only asset genuinely yours, unlike an audience rented from a platform."
            },
            {
    ...
    synthese: [
        ...
        },
        {
            ...
            a: 1,
            explication: "Without that figure you are not steering anything: you are spending."
        },
        {
