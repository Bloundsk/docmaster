    ...
    sections: {
        ...
        "temperature-and-randomness": [
            ...
            },
            {
                ...
                options: [
                    "The speed at which the text is generated by the model",
                    "How flat the probability distribution is",
                    "The maximum length of the answer produced"
                ],
                a: 1,
            ...
            },
            {
                ...
                options: [
                    ...
                    "Changing the temperature on every call, depending on the result"
                ],
                a: 0,
            ...
            },
            {
                ...
                options: [
                    ...
                    "Generating code that actually has to run",
        ...
        "evaluating-a-system": [
            // Series 1
            {
                ...
                options: [
                    ...
                    "It is reliable if the tester is experienced enough to judge it well"
                ],
                a: 0,
            ...
            },
            {
                ...
                options: [
                    ...
                    "Three to five, chosen among the commonest cases",
                    "Several thousand, so as to be genuinely complete"
                ],
                a: 0,
            ...
            },
            {
                ...
                options: [
                    "The easy ones, which pass in absolutely every case",
                    "Those whose right answer is “I do not know”",
                    "The longest and most expensive ones to run each time"
                ],
                a: 1,
            ...
            },
            {
                ...
                options: [
                    "Yes, it is the reference measure used in the field",
        ...
        "prompt-injection": [
            ...
            },
            {
                ...
                options: [
                    ...
                    "An instruction written by the user themselves, knowingly and on purpose"
                ],
                a: 1,
            ...
            },
            {
                ...
                options: [
                    ...
                    "Yes, by filtering out the suspicious keywords on the input"
                ],
                a: 0,
            ...
            },
            {
                ...
                options: [
                    "It settles the problem once and for all, definitively",
                    "It makes the vulnerability considerably worse",
            ...
            },
            {
                ...
                options: [
                    ...
                    "A flaw in the model itself, exploited from the outside"
                ],
                a: 1,
        ...
        "train-or-retrieve": [
            // Series 1
            {
                ...
                options: [
                    ...
                    "Reducing the cost of the calls that are made to the model each day",
            ...
            },
            {
                ...
                options: [
                    "Fine-tuning on the company's own internal data",
                    "The prompt, then examples inside the prompt",
                    "Changing vendor for another provider of models"
                ],
                a: 1,
            ...
            },
            {
                ...
                options: [
                    ...
                    "It can, but it is disabled by default almost everywhere"
                ],
                a: 0,
    ...
    synthese: [
        ...
        },
        {
            ...
            options: [
                ...
                "You trust the model to refuse the suspicious instructions itself",
        ...
        // Series 2
        {
            ...
            options: [
                ...
                "Which vendor should we choose for this particular project of ours?",
        ...
        },
        {
            ...
            options: [
                ...
                "It is required by the regulation currently in force",
                "It replaces the documentation of the whole project"
            ],
            a: 0,
        ...
        },
        {
            ...
            options: [
                ...
                "Automate as many of the tasks as can possibly be automated in the chain",
